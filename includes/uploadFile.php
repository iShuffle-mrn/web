<?php header('Content-Type: text/html; charset=utf-8');   
    ...
    $sql = "SELECT * FROM tests WHERE year='$year' AND moed='$moed' and semester='$semester' and course_id= (SELECT course_id from users_in_courses WHERE user_email='$user_email' AND course_name='$course')";  
